                ...
                try
                {
                    ...
                    switch (Source)
                    {
                        case ConnectionType.GAMESERVER:
                            ...
                            typeof(IProcessData).InvokeMember(((GameServerProcessPacketNumbers)PacketNumber).ToString(), BindingFlags.InvokeMethod | BindingFlags.NonPublic | BindingFlags.Static, null, null, obj);
                            break;
